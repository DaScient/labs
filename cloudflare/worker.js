// Cloudflare Worker with CORS on ALL responses
// Endpoints: /api/ping, /api/mock?symbol=AAPL, /api/summary?symbol=XXX, /api/options?symbol=XXX[&date=UNIX]
...
function cors(extra = {}) {
  return {
    ...
    "Access-Control-Allow-Methods": "GET, OPTIONS", // allow GET + preflight
